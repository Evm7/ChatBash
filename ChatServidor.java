...
public class ChatServidor {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /**
             * Accepts connections from listener continiously
             * Create a handler which manage the connection accepted
             * Executes runnable Handler by pool thread Executor.
             */
            while (true) {
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    //Server may have or not the converstaion written depending of next Line.
